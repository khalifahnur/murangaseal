...
const MembershipBanner: React.FC<MembershipBannerProps> = ({ 
  linkUrl = "https://murangaseal.co.ke/" 
}) => {
  ...
  return (
    <div className="relative bg-blue-100 text-gray-950 px-4 py-3 transition-all duration-300 ease-in-out">
      <div className="container mx-auto flex flex-col sm:flex-row items-center text-center text-sm sm:text-base pr-8 sm:pr-0">
        
        <p className="font-medium">
          Hurry! Memberships are currently on sale with a great discount.
        </p>
