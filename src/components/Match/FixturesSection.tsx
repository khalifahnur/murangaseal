...
//   return (
//     <section
//       className=" mozillaheadline min-h-80vh bg-white text-gray-900 py-12 px-4 sm:px-6 lg:px-8 relative overflow-hidden"
//       id="match"
//     >
//       <div
...
// Helper component to render each team's row cleanly
  ...
  return (
    <div className="mb-16 last:mb-0">
      ...
      {fixtures && fixtures.length > 0 ? (
        ...
        /* Empty state if one team has no matches, but the other does */
